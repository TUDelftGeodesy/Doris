...
class CreateDorisInputXml(object):
    ...
    def _create_xml(self):
        ...
        input = False
        while input == False:
            user_input = raw_input("Enter the path to the folder of the satellite data: ")
            if os.path.exists(user_input):
                self.input_file_dict['satellite_data_folder'] = user_input
                input = True
            else:
                print('The path is incorrect, use another path')
        ...
        input = False
        while input == False:
            user_input = raw_input("Do you want to generate the DEM file automaticly (Yes/No): ")
        ...
        input = False
        while input == False:
            self.input_file_dict['dem_folder'] = raw_input("Enter path to folder of the dem files: ")
        ...
        input = False
        while input == False:
            user_input = raw_input("Do you want to use parallel computing (Yes/No): ")
            if user_input == 'Yes' or user_input == 'No':
        ...
        tree.write(os.path.join(self.input_file_dict['datastack_folder'], 'stack_info.xml'))
